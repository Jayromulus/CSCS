namespace DND5ECharacterSheet.Data.Migrations
{
    ...
    public partial class maybeNoMoreDuplicates : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ArmourClass = c.Int(nullable: false),
                        MaxDexMod = c.Int(),
                        MinStrength = c.Int(),
                ...
                c => new
                    {
                        ...
                        BaseDexterity = c.Int(nullable: false),
                        BaseConstitution = c.Int(nullable: false),
                        BaseIntelligence = c.Int(nullable: false),
                        BaseWisdom = c.Int(nullable: false),
                        BaseCharisma = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        ProficienciesId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ClassProficiencies", t => t.ProficienciesId, cascadeDelete: true)
                .Index(t => t.ProficienciesId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ClassSelections", "ProficienciesId", "dbo.ClassProficiencies");
            ...
            DropIndex("dbo.ClassSelections", new[] { "ProficienciesId" });
